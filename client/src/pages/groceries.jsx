...
const Groceries = () => {
    ...
    // Function to fetch products filtered by Groceries category
    const fetchFilteredProducts = async () => {
        try {
            console.log('Fetching products...');
            const response = await axios.get('http://localhost:3000/api/products/filter-product', {
                params: {
                    category: 'groceries', // Filter by groceries category
                },
            });
    ...
    return (
        <div>
            ...
            {/* Centered Groceries Heading */}
            <h1 className="text-4xl font-bold text-center text-white bg-black bg-opacity-50 py-4 mb-8">Groceries</h1>

            {/* Main Container with Sidebar and Products */}
            <div className="min-h-screen flex" style={{
                backgroundImage: `url('https://image.shutterstock.com/image-photo/variety-fresh-organic-fruits-vegetables-260nw-1687571298.jpg')`,
