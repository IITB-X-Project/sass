...
import { FaInbox, FaClipboardList } from 'react-icons/fa';
    ...
    <div className="min-h-screen bg-gray-100 p-8">
      <div className="max-w-4xl mx-auto bg-white shadow-lg rounded-lg p-6">
        ...
        <div className="flex justify-between mb-8">
          <button
            className="w-1/2 bg-gradient-to-r from-blue-500 to-indigo-600 text-white py-3 rounded-lg flex items-center justify-center hover:from-blue-600 hover:to-indigo-700 transition duration-300 ease-in-out shadow-md mr-4"
